...
try {
	...
	echo "-r\t\t - max HTTP redirects (0 - disable redirects); natural number; default: 10", PHP_EOL;
	echo "-n\t\t - nesting level for recursive parsing (0 - infinity); natural number; default: 0", PHP_EOL;
	echo PHP_EOL;
	...
	echo "-p\t\t - max records to print (0 - infinity); natural number; default: 0", PHP_EOL;
	echo PHP_EOL;
